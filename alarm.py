...
I='covid'
G=['10:05',0, '11:05',1,'12:05',2,'13:35',3,'14:35',4];B=['18:30','Job','17:00',I,'21:00','Dish', '16:00', "Duolingo 'French Time'", '22:00', 'Sleep!'];subjects = {'Sunday': ['C.Math', 'Science', 'S.Studies', 'O.Maths', 'HPE'], 'Monday': ['Computer', 'English', 'Nepali', 'C.Maths', 'Science'], 'Tuesday': ['English', 'Social', 'O.Maths', 'Computer', 'HPE'], 'Wednesday': ['C.Maths', 'Nepali', 'Science', 'Social', 'HPE'], 'Thursday': ['O.Maths', 'Computer', 'Nepali', 'English', 'Computer'], 'Friday': ['Science', 'Social', 'English', 'O.maths', 'Computer']}
while True:
